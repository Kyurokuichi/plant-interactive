...
menuMore.event:add('update', function (dt)
    ...
    player.settings.masterVolume = updateVolume(masterVolume)
    player.settings.musicVolume = updateVolume(musicVolume)
    player.settings.SFXVolume = updateVolume(SFXVolume)
