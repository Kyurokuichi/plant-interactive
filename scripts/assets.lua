...
function assets.initialize()
    ...
    assets.image.frameButton4   = love.graphics.newImage('assets/frame-button4.png')
    ...
    assets.image.iconPlaySmall      = love.graphics.newImage('assets/icon-playsmall.png')
    assets.image.iconIndicatorLarge = love.graphics.newImage('assets/icon-indicatorlarge.png')
